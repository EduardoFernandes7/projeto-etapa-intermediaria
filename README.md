...
- **API Pública:** [ViaCEP](https://viacep.com.br/) para busca automatizada de endereços.
- **CI/CD:** GitHub Actions validando a integração com o serviço externo a cada commit.